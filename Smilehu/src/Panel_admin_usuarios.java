...
public class Panel_admin_usuarios extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Panel_admin_usuarios frame = new Panel_admin_usuarios();
	...
	public Panel_admin_usuarios() {
		...
		btn_modCita.setBounds(482, 11, 108, 23);
